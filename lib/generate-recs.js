...
(function () {
  ...
  // for each member, we have an array of their ratings for each provider
  ...
  return new Promise(function (resolve) {
    var promises = _.map(recs, function (results) {
...
function getRecs (currentMemberId, ratings) {
  ...
  // for each provider, get the predicted rating for 
  // a given member as a potential receiver
